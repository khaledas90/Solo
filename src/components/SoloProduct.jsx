...
export default function SoloProduct() {
    ...
    return (
        <div className="flex flex-col items-center bg-gray-900 text-white py-16 px-8 relative">
          
            <h1 className="text-lg md:text-2xl lg:text-3xl font-medium text-gray-300 mb-2 text-center" data-aos="fade-up">
                Welcome To The Next Generation Of
            </h1>
            <h2 className="text-3xl md:text-5xl lg:text-6xl font-bold text-white mb-4 text-center" data-aos="fade-up">
                RF MICRONEEDLING
            </h2>
            <p className="text-md md:text-lg lg:text-2xl font-light text-[#e2b770] italic text-center mb-8" data-aos="fade-up">
                No more Beauty Secrets, We all use Solo
            </p>

            <div className="relative w-full max-w-4xl flex items-center justify-center mb-8" data-aos="zoom-in">
                ...
                <img src={deviceImage} alt="SOLO RF Device" className="w-full max-w-sm md:max-w-md lg:max-w-lg rounded-lg shadow-lg" data-aos="zoom-in" />
            ...
            <div className="text-center text-gray-300 my-5 text-sm md:text-[15px] lg:text-lg" data-aos="fade-up">
